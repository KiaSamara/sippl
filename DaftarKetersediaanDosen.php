        ...
        <main class="mdl-layout__content mdl-color--grey-100">
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    <center><h2>Buat Ketersediaan Dosen Pembimbing</h2> </center>
                ...
                <div class="mdl-card__supporting-text">
                    <form action="#" class="form">
                        ...
                        <h5 class="mdl-card__title-text text-color--white">Nama Dosen</h5>
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <input class="mdl-textfield__input" type="text" id="first-name">
                                <label class="mdl-textfield__label" for="first-name">Nama Dosen</label>
                            </div>
            ...
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    <center><h2>Daftar Ketersediaan Dosen Pembimbing</h2> </center>
                    <div class="mdl-card__subtitle"></div>
                </div>
                ...
                <div class="mdl-card__supporting-text">
                    ...
                    <table class="mdl-data-table mdl-data-table--selectable mdl-shadow--2dp projects-table">
                        ...
                        <tr>
                            ...
                            <th style="width: 70%" class="mdl-data-table__cell--non-numeric">NAMA DOSEN</th>
