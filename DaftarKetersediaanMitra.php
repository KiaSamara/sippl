        ...
        <main class="mdl-layout__content mdl-color--grey-100">
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    <center><h2>Buat Ketersediaan Dosen Mitra</h2> </center>
                ...
                <div class="mdl-card__supporting-text">
                    <form action="#" class="form">
                        ...
                        <ul class="mdl-list pull-left">
                            <h5 class="mdl-card__title-text text-color--white">Mitra</h5>
                            <li class="mdl-list__item">
                                <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect checkbox--colored-green" for="checkbox-1">
                                    <input type="checkbox" id="checkbox-1" class="mdl-checkbox__input">
                                    <span class="mdl-checkbox__label">SMA Negeri 1</span>
                                </label>
                            </li>
                            <li class="mdl-list__item">
                                <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect checkbox--colored-orange" for="checkbox-2">
                                    <input type="checkbox" id="checkbox-2" class="mdl-checkbox__input">
                                    <span class="mdl-checkbox__label">SMA Negeri 3</span>
                                </label>
                            </li>
                            <li class="mdl-list__item">
                                <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect checkbox--colored-purple" for="checkbox-3">
                                    <input type="checkbox" id="checkbox-3" class="mdl-checkbox__input">
                                    <span class="mdl-checkbox__label">SMK Negeri 8</span>
                                </label>
                            </li>
                            <li class="mdl-list__item">
                                <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect checkbox--colored-red" for="checkbox-4">
                                    <input type="checkbox" id="checkbox-4" class="mdl-checkbox__input" checked>
                                    <span class="mdl-checkbox__label">SMK Negeri 10</span>
                                </label>
                            </li>
                        </ul>    
                            ...
                            <div class="mdl-textfield mdl-js-textfield full-size">
                                <h5 class="mdl-card__title-text text-color--white">Jumlah Kuota</h5>
                                    <input class="mdl-textfield__input" type="text" id="kuota_dosen"value="5">
            ...
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    <center><h2>Daftar Ketersediaan Mitra</h2> </center>
                    <div class="mdl-card__subtitle"></div>
                </div>
                ...
                <div class="mdl-card__supporting-text">
                    ...
                    <table class="mdl-data-table mdl-data-table--selectable mdl-shadow--2dp projects-table">
                        ...
                        <tr>
                            ...
                            <th style="width: 70%" class="mdl-data-table__cell--non-numeric">NAMA MITRA</th>
                            <th style="width: 30%" class="mdl-data-table__cell--non-numeric">KUOTA</th>
